...
def list_suppliers(
    ...
    return list_records(db, Supplier, search=search, search_fields=("name", "phone", "email", "country"), offset=offset, limit=limit)
...
def list_orders(
    ...
    return list_records(db, Order, search=search, search_fields=("product_name", "status", "currency"), offset=offset, limit=limit)
